...
class Template extends CI_Controller{
    ...
    function adminTemp($template, $data=null){
        ...
        $data['_admHeader']=$this->_ci->load->view('admin/adminHeader',$data, true);
        $data['_admSidebar']=$this->_ci->load->view('admin/adminSideBar',$data, true);
        $data['_admFooter']=$this->_ci->load->view('admin/adminFooter',$data, true);
        $this->_ci->load->view('admin/adminTemplate.php',$data);
    }
